...
from boundingbox._2_train.model import EventBBNet
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="boundingbox/_2_train/runs/5/best_model.pth", help="Path to trained model (.pth)")
